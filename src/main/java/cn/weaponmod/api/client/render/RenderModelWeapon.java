...
/**
 * 给ModelWeapon专用的渲染器，提供给RendererModelBulletWeapon调用
 *@author Nolife_M
 */
public class RenderModelWeapon extends RenderModelItem{
	...
	//单个动作渲染器
	public RenderAction mainAction = new RenderAction();
	public RenderAction ammoAction = new RenderAction();
	public RenderAction shellAction = new RenderAction();
	public RenderAction slideAction = new RenderAction();
	
	public RenderAction leftAction = new RenderAction();
	public RenderAction rightAction = new RenderAction();
	...
	public RenderModelWeapon(IWeaponModel mdl, ResourceLocation texture) {
	...
	public void renderEquipped(ItemStack item, RenderBlocks render,
		...
		WeaponGenericE wpnType = (WeaponGenericE) item.getItem();
	...
	public RenderModelWeapon setFirstPersonOffset(double b0, double b1, double b2) {
		initVec(firstPersonOffset, b0, b1, b2);
		return this;
	}

	public RenderModelWeapon setFirstPersonRotaion(float x, float y, float z) {
		initVec(firstPersonRotation, x, y, z);	
		return this;
	}
	
	public RenderModelWeapon setFirstPersonScale(double d) {
		firstPersonScale = d;
		return this;
	}

	public RenderModelWeapon setLeftHandOffset(double b0, double b1, double b2) {
		initVec(leftHandOffset, b0, b1, b2);
		return this;
	}

	public RenderModelWeapon setLeftHandRotation(float x, float y, float z) {
		initVec(leftHandRotation, x, y, z);	
		return this;
	}

	public RenderModelWeapon setRightHandOffset(double b0, double b1, double b2) {
		initVec(rightHandOffset, b0, b1, b2);
		return this;
	}

	public RenderModelWeapon setRightHandRotation(float x, float y, float z) {
