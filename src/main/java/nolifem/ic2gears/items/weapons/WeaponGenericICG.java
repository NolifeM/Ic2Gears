...
import nolifem.ic2gears.items.weapons.Actions.ActionAutomaticShootE;
import nolifem.ic2gears.items.weapons.Actions.ActionChamberingIn;
import nolifem.ic2gears.items.weapons.Actions.ActionChamberingOut;
import nolifem.ic2gears.items.weapons.Actions.ActionReloadEBulletIn;
import nolifem.ic2gears.items.weapons.Actions.ActionReloadEBulletOut;
import nolifem.ic2gears.items.weapons.Actions.ActionReloadEClipIn;
import nolifem.ic2gears.items.weapons.Actions.ActionReloadEMagazineIn;
import nolifem.ic2gears.items.weapons.Actions.ActionReloadEMagazineOut;
import nolifem.ic2gears.items.weapons.Actions.ActionShootE;
...
public class WeaponGenericICG extends WeaponGeneric{
	 ...
	 */
	public Action
		actionShoot = new ActionShootE(4, 2 , "ic2gears:weapons.pistolShoot").setShootRate(1).setConsume(true, this.loadingConsume),
		actionShootAuto = new ActionAutomaticShootE((ActionShootE)actionShoot,300,1),
		actionUplift = new ActionUplift(3.0F,1.0F,.5F,10.0F),
		actionChamberingIn = new ActionChamberingIn("","",5,15),
		actionChamberingOut = new ActionChamberingOut(40,"",""),
		actionReloadBulletIn = new ActionReloadEBulletIn(20,20,20, "", "", ""),
		actionReloadBulletOut = new ActionReloadEBulletOut(10, "", ""),
		actionReloadClipIn = new ActionReloadEClipIn(10, ""),
		actionReloadMagezineIn = new ActionReloadEMagazineIn(5,1, ""),
		actionReloadMagezineOut = new ActionReloadEMagazineOut(15,""),
