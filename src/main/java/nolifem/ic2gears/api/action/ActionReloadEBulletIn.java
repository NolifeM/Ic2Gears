...
import nolifem.ic2gears.api.action.parts.ActionBREnd;
import nolifem.ic2gears.api.action.parts.ActionBRStart;
import nolifem.ic2gears.api.action.parts.ActionBulletSingleIn;
...
public class ActionReloadEBulletIn extends ActionReload{
	...
	public boolean onActionEnd(World world, EntityPlayer player, InfWeapon inf) {
		...
		if(curItem == null || !(curItem.getItem() instanceof WeaponGenericICG) || inf.getTickLeft(this) > 0)
			return false;
